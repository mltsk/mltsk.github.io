...
//     speakersPlus = document.querySelector('.speakers__plus');
...
// callback__form.addEventListener('submit', (e)=> {
//     e.preventDefault();
//     callback.style.display = 'none';
...
// speakersClose.addEventListener('click', ()=> {
//     speakersPopup.style.display = 'none';
//     speakersTriangle.style.display = 'none';
// });

// speakersPlus.addEventListener('click', ()=> {
